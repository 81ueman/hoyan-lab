...
func ApplyNftablesPolicies(ctx context.Context, runner ribcompare.Runner, topo *topology.Topology, out io.Writer) error {
...
func nftablesPolicyNodes(topo *topology.Topology) []topology.Node {
	if topo == nil {
		return nil
	}
