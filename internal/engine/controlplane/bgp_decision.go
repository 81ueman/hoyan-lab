...
type BGPDecisionProcess interface {
	Less(receiver topology.Node, a, b RIBEntry) bool
	Equivalent(receiver topology.Node, a, b RIBEntry) bool
}
...
func (d defaultBGPDecisionProcess) Less(receiver topology.Node, a, b RIBEntry) bool {
	a = a.Normalize()
	b = b.Normalize()
...
func (d defaultBGPDecisionProcess) Equivalent(receiver topology.Node, a, b RIBEntry) bool {
	a = a.Normalize()
	b = b.Normalize()
	if a.SourceKind == topology.RouteSourceOSPF || b.SourceKind == topology.RouteSourceOSPF {
