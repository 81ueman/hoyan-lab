...
func routeNextHopAddress(idx *topology.TopologyIndex, node string, route sim.RIBEntry) string {
...
func expectedRouteValid(node topology.Node, route sim.RIBEntry) bool {
