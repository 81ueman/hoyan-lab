...
type NormalizedFIBRoute struct {
	...
	ConnectedClass topology.ConnectedRouteClass `json:"connected_class,omitempty"`
...
type Collector interface {
	Collect(ctx context.Context, runner Runner, nodes []topology.Node) ([]NormalizedFIBRoute, error)
}
